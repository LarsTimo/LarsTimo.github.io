...
karte.on("load, zoomend moveend", function () {
    ...
    const geonamesUrl = `https://secure.geonames.org/wikipediaBoundingBoxJSON?formatted=true&north=${ausschnitt.n}&south=${ausschnitt.s}&east=${ausschnitt.o}&west=${ausschnitt.w}&username=larstimo&style=full&maxRows=50&lang=de`;
